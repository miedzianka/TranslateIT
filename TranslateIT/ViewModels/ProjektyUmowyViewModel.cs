...
{
    public class ProjektyUmowyViewModel : WorkspaceViewModel
    {
        #region Properties
        ...
        {
            ZaFilmyPracownik = new ProjektUmowaPracownikB(TranslateITEntities).UmowaPracownikFilmy(IdFirmy, DataOd, DataDo);
        }
        private void ObliczOdcinkiPracownikClick()
        {
            ZaOdcinkiPracownik = new ProjektUmowaPracownikB(TranslateITEntities).UmowaPracownikOdcinki(IdFirmy, DataOd, DataDo);
        }
        private void ObliczZarobkiPracownikaClick()
        {
            ZarobkiPracownik = new ProjektUmowaPracownikB(TranslateITEntities).ZarobkiPracownikaZaOkres(IdFirmy, DataOd, DataDo);
        }
        #endregion
        #region Helpers Company
        private void ObliczFilmyFirmaClick()
        {
            ZaFilmyFirma = new ProjektUmowaFirmaB(TranslateITEntities).UmowaFirmaFilmy(IdFirmy, DataOd, DataDo);
        }
        private void ObliczOdcinkiFirmaClick()
        {
            ZaOdcinkiFirma = new ProjektUmowaFirmaB(TranslateITEntities).UmowaFirmaOdcinki(IdFirmy, DataOd, DataDo);
        }
        private void ObliczBudzetFirmaClick()
        {
            BudzetFirma = new ProjektUmowaFirmaB(TranslateITEntities).StanBudzetuZaProjekt(IdFirmy, DataOd, DataDo);
        }
        #endregion
        #region Constructor
        public ProjektyUmowyViewModel()
        {
            base.DisplayName = "Umowy za projekty";
